...
const milestones = [
  {
    ...
    icon: <Zap className="w-5 h-5 text-kfa-500" />,
    badge: "Stage 1",
  },
  {
    stage: "Improving",
    ...
    icon: <Flame className="w-5 h-5 text-kfa-500" />,
    badge: "Stage 2",
  },
  {
    stage: "Fast",
    ...
    icon: <Award className="w-5 h-5 text-kfa-500" />,
    badge: "Stage 3",
  },
  {
    stage: "Advanced",
    ...
    <section className="py-20 md:py-28 bg-white dark:bg-kfn-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-1 bg-kfn-200 dark:bg-kfn-800 -translate-y-1/2 z-0">
            <motion.div
              initial={{ width: "0%" }}
              ...
              className="h-full bg-gradient-to-r from-kfa-500 via-kfa-500 to-amber-500 rounded-full"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
            {milestones.map((m, idx) => (
              <motion.div
                ...
                className="bg-white dark:bg-kfn-900 p-6 rounded-3xl border border-kfn-200/80 dark:border-kfn-800 shadow-md hover:shadow-xl transition-all duration-300 flex flex-col justify-between"
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="w-12 h-12 rounded-2xl bg-kfn-100 dark:bg-kfn-800 flex items-center justify-center">
                      {m.icon}
                    </div>
                    <span className="text-xs font-bold text-kfa-600 dark:text-kfa-400 font-mono">
                      {m.badge}
                    </span>
                  </div>

                  <div>
                    <h3 className="text-xl font-bold text-kfn-900 dark:text-white">{m.stage}</h3>
                    <div className="text-sm font-bold font-mono text-kfa-600 dark:text-kfa-400 mt-0.5">
                      {m.speed}
                    </div>
                  </div>
                ...
                <div className="mt-6 pt-4 border-t border-kfn-100 dark:border-kfn-800 text-[11px] font-semibold text-kfn-500 dark:text-kfn-400 flex items-center justify-between">
