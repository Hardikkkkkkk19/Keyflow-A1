...
export const StagedLoadingScreen: React.FC<StagedLoadingScreenProps> = ({
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[9999] bg-[#050807] text-[#F3F5F2] flex flex-col items-center justify-center p-6 select-none overflow-hidden"
    >
      ...
      <div className="relative z-10 w-full max-w-sm flex flex-col items-center gap-8 text-center">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="w-16 h-16 rounded-2xl bg-[#0D1210] border border-[#18C69A]/40 p-0.5 shadow-2xl shadow-[#18C69A]/20 flex items-center justify-center">
            {progress >= 100 ? (
        ...
        <div className="space-y-2">
          <h1 className="font-serif italic text-3xl tracking-wide text-[#F3F5F2] font-semibold">
            KEYFLOW
          </h1>
        ...
        <div className="w-full space-y-3">
          <div className="relative w-full h-2 bg-[#0D1210] border border-[#F3F5F2]/10 rounded-full overflow-hidden p-0.5">
            <motion.div
          ...
          <div className="flex items-center justify-between text-xs font-mono text-[#68716C] px-1">
            <span>KEYBOARD TELEMETRY</span>
            <span className="font-bold text-[#F3F5F2]">{progress}%</span>
          </div>
        </div>
      </div>
    </motion.div>
