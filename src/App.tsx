...
function AppContent() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0A0A0A] text-[#F5F5F5] bg-radial-atmosphere font-sans antialiased transition-colors duration-300 flex flex-col selection:bg-[#18C69A]/30 selection:text-white">
        ...
        <main className={`flex-1 ${isLandingPath ? "pt-0" : "pt-16 sm:pt-20"}`}>
          <Suspense
            fallback={
              <div className="min-h-[60vh] flex flex-col items-center justify-center p-8 space-y-4">
                <div className="w-10 h-10 border-4 border-[#18C69A]/30 border-t-[#18C69A] rounded-full animate-spin" />
                <p className="text-xs font-semibold text-[#A0A0A0]">Loading KEYFLOW...</p>
              </div>
            }
          >
            <AnimatePresence mode="wait" initial={false}>
              ...
              >
                ...
                {currentPath === "/challenges" && (
                  <ChallengesPage
                    onStartChallenge={handleStartDrillText}
                    onNavigate={handleNavigate}
                  />
                )}
                ...
                {(currentPath === "/coach" || currentPath === "/ai-coach") && (
                  <CoachPage
                    onStartCustomWorkout={handleStartDrillText}
                    onNavigate={handleNavigate}
                  />
                )}
        ...
        {/* Footer */}
        {isLandingPath && <Footer onNavigate={handleNavigate} />}
      </div>
    </>
  );
}
